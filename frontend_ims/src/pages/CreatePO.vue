<template>
    <div class="relative h-full w-full min-h-fit min-w-[200px]">
                            ...
                            <div class="relative flex flex-1 overflow-hidden lg:hidden">
                                ...
                                <div class="flex flex-1 overflow-auto">
                                    ...
                                    <div class="my-2 flex-1 gap-3 overflow-hidden min-h-fit content-start grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] p-1">
                                        ...
                                        <!-- grid items -->
                                        <div v-if="!dataStatus" v-for="item in filteredItemsListData" class="cursor-default flex flex-col shadow-emerald-300 shadow-[0_2px_4px] rounded-lg max-h-full">
                                            ...
                                            <div class="flex items-center  justify-between pt-5 pb-3 mx-5 mb-2 border-b border-gray-200">
                                                ...
                                                <div class="justify-center ml-auto w-fit">
                                                    <button
                                                        type="button" 
                                                        @click="toggleSelectedItem(item)" 
                                                        :class=" selectedIds.includes(item.id) ? 'text-white bg-red-500' : 'border-2  border-[#45a049] text-[#45a049] bg-[#eef3ee]' " class="flex items-center justify-center rounded-full size-12"
                                                    >
        ...
        >
            <div v-show="viewingPOForm" class="flex flex-col w-full max-h-[1200px] min-h-[1000px] h-full max-w-[1300px] mx-auto ">
                    ...
                    <div class="shadow-[0px_2px_4px_rgba(0,0,0,0.1)] overflow-hidden flex-1 p-6 bg-white rounded-xl flex flex-col mb-4">
                        ...
                        <section class="flex flex-col mb-6">
                            ...
                            <div @click="viewingSuppliersMenu = !viewingSuppliersMenu" class="relative cursor-pointer value-style suppliers-dropdown">
                                <div class="flex">
                                    <p v-if="formData.supplierName">{{ formData.supplierName }}</p>
                            ...
                            <div class="relative flex flex-1 overflow-hidden lg:hidden">
                                ...
                                <div class="flex flex-1 overflow-auto">
                                    ...
                                    <div class="my-2 content-start flex-1 gap-3 p-1 overflow-hidden min-h-fit grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))]">
                                        ...
                                        <!-- grid items -->
                                        <div v-if="!dataStatus" v-for="item in formData.selectedItemsList" class="cursor-default flex flex-col shadow-emerald-300 shadow-[0_2px_4px] rounded-lg max-h-full">
...
import ButtonRedOutline from '../components/buttons/ButtonRedOutline.vue';
...
function submitPO(){
    ...
    axiosClient.post('/api/save-purchase-order', formData.value)
        .then(response => {
            loading.value = false
            console.log(response);
